...
namespace RenPy.Script
{
	public class RenPyVariable : RenPyLine
	{
		...
		public override void Execute(RenPyDisplay display) {
			Static.LogRenPy("$ " + m_varName + " " + m_assignment.GetOp() + " " + m_value);
			
			m_assignment.Assign(display, m_varName, m_value);
		}
		
		public override string ToString() {
			return base.ToString() + ": \"" + m_varName + "\" " + m_assignment.GetOp() + " \"" + m_value + "\"";
		}
	}
	
	abstract class Assignment {
		public abstract void Assign(RenPyDisplay display, string varName, string value);
		public abstract string GetOp();
	}
	
	class NormalAssignment : Assignment {
		public override void Assign(RenPyDisplay display, string varName, string value) {
